...
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeCap(Paint.Cap.ROUND);// 设置笔刷的形状
...
//                canvas.drawArc(oval, -265, 360 * progress / max, false, paint); // 根据进度画圆弧(起始位置为底部)
                break;
            }
            case FILL: {
...
//                    canvas.drawArc(oval, -265, 360 * progress / max, true, paint); // 根据进度画圆弧(起始位置为底部)
                break;
            }
        }
    }
